...
**[markdown-guide/](markdown-guide/)** - 실습 가이드 작성 방법 (9개 문서)
...
- [이미지 가이드](markdown-guide/09-image-guidelines.md)
- [비용 Alert 가이드](markdown-guide/10-cost-alert-guide.md)
...
- 비용 Alert? → [10-cost-alert-guide.md](markdown-guide/10-cost-alert-guide.md)
