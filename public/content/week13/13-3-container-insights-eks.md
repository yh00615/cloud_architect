...
> | 리소스명               | 타입/사양                 | IaC |                     비용 |
> | ---------------------- | ------------------------- | :-: | -----------------------: |
> | Amazon EKS             | 컨트롤 플레인             | ❌  |               $0.10/시간 |
> | Amazon EC2             | t3.medium × 2             | ❌  | $0.052/시간 (인스턴스당) |
> | NAT Gateway            | N/A                       | ❌  |              $0.059/시간 |
> | Elastic Load Balancing | Classic LB                | ❌  |              $0.025/시간 |
> | Amazon CloudWatch Logs | 로그 스토리지             | ❌  |              $0.50/GB/월 |
> | Amazon CloudWatch      | Container Insights 메트릭 | ❌  |  커스텀 메트릭 요금 적용 |
>
> - **예상 실습 시간**: 2-3시간
> - **예상 총 비용**: 약 $0.54-0.81 (실무 환경 온디맨드 기준, 데이터 전송 비용 별도 발생 가능)
>
> **무료 플랜**
>
...
> **실무 팁**
>
> 💡 Amazon EKS 클러스터는 시간당 $0.10의 고정 비용이 발생하며, NAT Gateway도 시간당 $0.059가 부과됩니다. 실습 종료 후 반드시 클러스터를 삭제하여 추가 비용을 방지하세요. 프로덕션 환경에서는 Cluster Autoscaler를 사용하여 노드 수를 자동으로 조정하고, Spot 인스턴스를 활용하여 비용을 최대 90%까지 절감할 수 있습니다.
>
> **참고**
>
> ℹ️ 이 실습에서는 Amazon EKS 클러스터와 t3.medium 인스턴스를 사용합니다. 클러스터 삭제에 10-15분이 소요되므로, 실습 종료 시 반드시 삭제 완료를 확인한 후 퇴실하세요.
>
> **리전별로 요금이 다를 수 있습니다. 최신 요금은 아래 링크에서 확인하세요.**
>
> 📘 [Amazon EKS 요금](https://aws.amazon.com/eks/pricing/) | 📘 [Amazon EC2 요금](https://aws.amazon.com/ec2/pricing/) | 📘 [Amazon VPC 요금](https://aws.amazon.com/vpc/pricing/) | 📘 [Amazon CloudWatch 요금](https://aws.amazon.com/cloudwatch/pricing/) | 🧮 [AWS 요금 계산기](https://calculator.aws/)
