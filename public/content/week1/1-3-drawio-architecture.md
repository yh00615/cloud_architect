...
> [!TIP]
> **아이콘 복제 방법**:
> 1. 배치한 아이콘을 선택한 상태에서 **마우스 오른쪽 버튼**을 클릭합니다.
> 2. 메뉴에서 **Duplicate**를 선택하면 동일한 크기의 아이콘이 복제됩니다.
> 3. **단축키**: **Cmd+D(Mac)** 또는 **Ctrl+D(Windows)**를 사용하면 더 빠르게 복제할 수 있습니다.
> 4. 또는 **Cmd/Ctrl**을 누른 채로 드래그해도 복제됩니다.
