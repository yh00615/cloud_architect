...
19. 상태가 "**CREATE_COMPLETE**"로 변경될 때까지 기다립니다.
    <img src="/images/week1/1-1-step19-stack-complete.png" alt="CloudFormation 스택 생성 완료 상태" class="guide-img-md" />
20. **Outputs** 탭을 선택합니다.
21. 출력값들을 확인하고 메모장에 복사합니다:
    <img src="/images/week1/1-1-step21-outputs.png" alt="CloudFormation 스택 Outputs 탭의 출력값" class="guide-img-md" />
...
8. [[Add new tag]] 버튼을 클릭한 후 다음 태그를 추가합니다:
...
7. 검색 결과에서 2개의 버킷이 표시됩니다.
8. **Tags** 열에서 `quicktable-reservations-{접미사}` 버킷의 태그 개수를 클릭합니다.
...
10. 팝업 창을 닫습니다.
11. **Tags** 열에서 `quicktable-logs-{접미사}` 버킷의 태그 개수를 클릭합니다.
12. 태그 목록을 확인합니다.
...
14. 검색 결과에서 `quicktable-logs-{접미사}` 버킷을 체크합니다.
...
15. [[Manage tags of selected resources]] 버튼을 클릭합니다.
...
16. **Edit tags of all selected resources** 섹션에서 [[Add tag]] 버튼을 클릭한 후 다음 태그를 추가합니다:
...
17. [[Review and apply tag changes]] 버튼을 클릭합니다.
...
19. [[Apply changes to all selected]] 버튼을 클릭합니다.
...
1. 왼쪽 메뉴에서 **AWS Resource Groups**를 선택합니다.
...
4. **Grouping criteria** 섹션에서 다음을 입력합니다:
   ...
   - **Tag key**: `Week`
   - **Tag value**: `1-1`
5. 아래로 스크롤하여 [[Preview group resources]] 버튼을 클릭합니다.
...
2. 왼쪽 메뉴에서 **Stacks**를 선택합니다.
3. `week1-1-tag-editor-lab-stack` 스택을 선택합니다.
4. [[Delete stack]] 버튼을 클릭합니다.
   <img src="/images/week1/1-1-cleanup-step4-delete-stack.png" alt="CloudFormation 스택 Delete 버튼" class="guide-img-sm" />
5. 확인 창이 나타나면 입력 필드에 삭제할 스택 이름을 입력합니다.
...
8. AWS Management Console 검색창에 `Resource Groups & Tag Editor`을 입력하고 선택합니다.
9. 왼쪽 메뉴에서 **Saved resource groups**를 선택합니다.
10. `week1-1-lab-resources` 그룹 이름을 클릭하거나 그룹을 선택한 후 [[View details]] 버튼을 클릭합니다.
11. [[Delete]] 버튼을 클릭합니다.
...
2. **Regions**에서 `All regions`를 선택합니다.
3. **Resource types**에서 `All supported resource types`를 선택합니다.
4. **Tags** 섹션에서 다음 태그를 입력합니다:
   - **Tag key**: `Week`
   - **Optional tag value**: `1-1`
5. [[Search resources]] 버튼을 클릭합니다.
6. 검색 결과가 비어있는지 확인합니다.
