...
1. AWS Management Console에 로그인한 후 상단 검색창에서 `Well-Architected Tool`을 검색하고 선택합니다.
...
12. 아래로 스크롤하여 **Trusted Advisor** 섹션으로 이동합니다.
13. **Trusted Advisor** 섹션은 선택사항이므로 활성화하지 않습니다.
...
**평가 포인트:**
- QuickTable은 현재 고정 크기 EC2 인스턴스를 사용합니다
...
- 탐지 제어: CloudTrail, Amazon GuardDuty, Security Hub
- 인프라 보호: Amazon VPC, 보안 그룹, WAF
...
**주요 영역:**
- 비용 인식: 태깅, Cost Explorer, 예산
- 비용 효율적인 리소스: 적절한 크기 조정, Spot 인스턴스
- 수요 및 공급 관리: Auto Scaling, 서버리스
