...
> | Amazon Bedrock Agent         | 요청당                   | ❌  |                          $0.00025-0.002/요청 |
> | AWS Lambda                   | Python 3.12              | ❌  |       $0.20/100만 요청 + $0.0000166667/GB-초 |
> | Amazon DynamoDB              | 온디맨드 테이블          | ❌  | 읽기 $0.25/100만 요청, 쓰기 $1.25/100만 요청 |
> | Amazon OpenSearch Serverless | 최소 2 OCU (Week 14-2)   | ❌  |                               $0.24/OCU/시간 |
>
> - **예상 실습 시간**: 1-2시간
> - **예상 총 비용**: 약 $0.48-0.96/시간 (OpenSearch Serverless 2 OCU 포함, 실무 환경 온디맨드 기준)
>
> **무료 플랜**
>
...
> **실무 팁**
>
> 💡 Week 14-2에서 생성한 Amazon OpenSearch Serverless 컬렉션이 남아있다면 시간당 $0.48 비용이 계속 발생합니다. 14-2 실습 후 리소스를 정리하지 않았다면 반드시 확인하고 삭제하세요. Amazon Bedrock Agent는 요청당 과금되므로 불필요한 테스트를 줄이면 비용을 절감할 수 있습니다.
>
> **참고**
>
> ℹ️ 이 실습에서는 Amazon Bedrock Agent와 AWS Lambda를 사용합니다. Week 14-2에서 생성한 OpenSearch Serverless 컬렉션이 남아있으면 추가 비용이 발생하므로 반드시 확인하세요.
>
> **리전별로 요금이 다를 수 있습니다. 최신 요금은 아래 링크에서 확인하세요.**
>
> 📘 [Amazon Bedrock 요금](https://aws.amazon.com/bedrock/pricing/) | 📘 [AWS Lambda 요금](https://aws.amazon.com/lambda/pricing/) | 📘 [Amazon DynamoDB 요금](https://aws.amazon.com/dynamodb/pricing/) | 📘 [Amazon OpenSearch Service 요금](https://aws.amazon.com/opensearch-service/pricing/) | 🧮 [AWS 요금 계산기](https://calculator.aws/)
