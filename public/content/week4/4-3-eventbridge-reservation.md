...
>
> 1. **AWS CloudFormation 템플릿**: `week4-3-quicktable-events-lab.yaml` 파일을 텍스트 에디터로 열어 `InitializeAvailabilityFunction` 함수 코드에서 `2026-03-20`을 원하는 날짜로 변경한 후 스택을 생성합니다.
...
21. Amazon EventBridge 콘솔로 이동합니다.
...
29. **Code** 탭을 선택합니다.
30. 함수 코드에서 다른 AWS Lambda 함수를 직접 호출하는 코드가 없음을 확인합니다.
...
34. Amazon EventBridge 콘솔로 이동합니다.
...
40. Amazon EventBridge 콘솔로 이동합니다.
