...
7. Amazon ECR 로그인이 성공했는지 확인합니다 ("Login Succeeded" 메시지).
...
11. Amazon ECR에 이미지가 성공적으로 푸시되었는지 확인합니다 ("digest: sha256:..." 메시지).
...
15. Amazon ECR 콘솔로 이동합니다.
16. 생성한 Amazon ECR 리포지토리를 선택합니다.
