...
>
> - **예상 실습 시간**: 30분-1시간
> - **예상 총 비용**: 약 $0.01 미만 (실습 규모 기준, 실무 환경 온디맨드 기준)
>
> **무료 플랜**
>
...
13. [[Next]] 버튼을 클릭합니다.
14. **Review and create** 페이지로 이동합니다.
...
> [!WARNING]
> 다음 단계를 **반드시 수행**하여 불필요한 보안 위험을 방지하세요.
...
> [!NOTE]
> IAM은 글로벌 서비스이므로 All regions를 선택해야 합니다.
...
1. IAM 콘솔로 이동합니다.
2. 왼쪽 메뉴에서 **Roles**를 선택합니다.
3. `S3ReadOnlyRole`을 검색하고 선택합니다.
4. [[Delete]] 버튼을 클릭합니다.
5. 확인 창에서 `S3ReadOnlyRole`을 입력합니다.
6. [[Delete]] 버튼을 클릭합니다.
...
2. 정책을 추가한 사용자를 검색하고 클릭합니다.
3. **Permissions** 탭을 선택합니다.
4. `AssumeS3ReadOnlyRolePolicy`의 체크박스를 선택합니다.
5. [[Remove]] 버튼을 클릭합니다.
6. 확인 창에서 [[Remove]] 버튼을 다시 클릭합니다.
...
> [!NOTE]
> 기존 IAM 사용자를 사용한 경우 이 단계를 건너뜁니다.

1. 왼쪽 메뉴에서 **Users**를 선택합니다.
2. `lab-user`를 검색하고 클릭합니다.
3. **Security credentials** 탭을 선택합니다.
4. **Access keys** 섹션에서 Access Key의 **Actions** > [[Delete]]를 선택합니다.
5. 확인 창에서 [[Delete]] 버튼을 클릭합니다.
6. 사용자 목록으로 돌아가서 `lab-user`를 선택합니다.
7. [[Delete]] 버튼을 클릭합니다.
8. 확인 창에서 `lab-user`를 입력하고 [[Delete]] 버튼을 클릭합니다.
