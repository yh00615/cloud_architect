...
export const labEnvironments: LabEnvironment[] = [
    ...
    // ========================================
    {
        ...
        notes: '태스크 0에서 CloudFormation으로 QuickTable 리소스 생성, Tag Editor로 태그 관리'
    },
    {
        week: 1,
        session: 2,
        ...
        files: [
            {
                name: 'README.md',
                type: 'document',
                description: '아키텍처 다이어그램 작성 가이드',
                usedInTask: '참고 자료'
            },
            {
                name: 'template-info.md',
                type: 'document',
                description: 'draw.io 템플릿 정보 및 사용법',
                usedInTask: '참고 자료'
            }
        ],
    ...
    // ========================================
    {
        ...
        notes: '태스크 0에서 CloudFormation으로 lab-user 생성, 정책은 콘솔에서 직접 생성'
    },
    {
        week: 2,
        session: 2,
        ...
        notes: '태스크 0에서 CloudFormation으로 lab-user + S3 버킷 생성, IAM 역할은 콘솔에서 직접 생성'
    },
    {
        week: 2,
        session: 3,
    ...
    // ========================================
    {
        ...
        notes: '태스크 0에서 CloudFormation으로 VPC 환경 구축, VPC Endpoint는 콘솔에서 직접 생성'
    },
    {
        week: 3,
        session: 2,
        ...
        notes: '태스크 0에서 CloudFormation으로 3-Tier VPC 환경 구축, 보안 그룹 규칙은 콘솔에서 직접 설정'
    },
    {
        week: 3,
        session: 3,
    ...
    },
    {
        ...
        cloudFormationResources: [],
        notes: 'EventBridge 기반 이벤트 처리 시스템, Lambda와 EventBridge는 콘솔에서 직접 생성'
    },
    ...
    // ========================================
    {
        ...
        files: [
            {
                ...
                type: 'cloudformation',
                description: 'VPC 환경 CloudFormation 템플릿 (VPC, 서브넷, 보안 그룹, DB 서브넷 그룹)',
                usedInTask: '태스크 0: 실습 환경 구축'
            },
            {
        ...
        notes: 'CloudFormation으로 네트워크 환경 자동 생성, RDS Multi-AZ 인스턴스는 콘솔에서 직접 생성'
    },
    {
        week: 5,
        session: 2,
    ...
    },
    {
        ...
        notes: 'CloudFormation으로 클러스터 자동 생성 후 kubectl 명령 실습. 선택사항: 마지막 섹션에서 콘솔로 클러스터 수동 생성 방법 안내'
    },
 ...
 * 특정 세션의 환경 정보 가져오기
 */
export const getSessionEnvironment = (week: number, session: number): LabEnvironment | undefined => {
    return labEnvironments.find(env => env.week === week && env.session === session)
}
